...
namespace SistemaBibliotecaOnlineNasa3PONTOZERO
{
    class Program
    {
        ...
        public static void AlocarUmLivro()
        {
            ...
            {
                Console.WriteLine("Nenhum livro encontrado na base de dados.");
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// Metodo que compaa dias strings deixando em caixa baixa e removendo espaços vazios dentro da mesma.
        /// </summary>
