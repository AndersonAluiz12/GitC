...
namespace BeepAula
{
    static class Tetris
    {
        ...
        {  
            ...
            {
                //Atiaçoza o valor da variavel "dateVerify" com a hora e minutos atuais
                dateVerify = DateTime.Now.ToString("HH:mm");
            }

            //Seta  tempo de incremento entre as execuções
            ...
            switch (fileira)
            {
                ...
                case "1":
                    {//Executa a chamada de acordo com o numero escolhido
                        Fileira1(startTimerIcrement); } break;//O break finalizado o processo     
                ...
                default: { Console.WriteLine("Não foi uma escolha valida dentro do menu de opcoes"); } break;
            }
